...
package net.sourceforge.plantumldependency.main.option.exclude;
...
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE10;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE12;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE3;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE8;
...
public class PlantUMLDependencyExcludeOptionTest extends DeepCloneableObjectTest < PlantUMLDependencyExcludeOption > {
    ...
    /**
     * Test method for
     * {@link net.sourceforge.plantumldependency.main.option.exclude.PlantUMLDependencyExcludeOption#getDefaultArgumentAsStringIfOptionSpecified(net.sourceforge.mazix.cli.command.CommandLine)}
     * .
     *
     * @throws CommandLineException
     */
