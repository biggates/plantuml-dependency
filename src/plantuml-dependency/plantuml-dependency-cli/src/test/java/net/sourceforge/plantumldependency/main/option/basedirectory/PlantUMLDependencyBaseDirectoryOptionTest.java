...
package net.sourceforge.plantumldependency.main.option.basedirectory;
...
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE2;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE3;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE4;
...
public class PlantUMLDependencyBaseDirectoryOptionTest extends
    ...
    /**
     * Test method for
     * {@link net.sourceforge.plantumldependency.main.option.basedirectory.PlantUMLDependencyBaseDirectoryOption#getDefaultArgumentAsStringIfOptionSpecified(net.sourceforge.mazix.cli.command.CommandLine)}
     * .
     *
     * @throws CommandLineException
     */
