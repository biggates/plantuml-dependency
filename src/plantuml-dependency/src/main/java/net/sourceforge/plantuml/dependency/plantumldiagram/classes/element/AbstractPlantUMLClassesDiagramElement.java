...
public abstract class AbstractPlantUMLClassesDiagramElement implements PlantUMLClassesDiagramElement {
    ...
    private PlantUMLClassesDiagramElementTag elementTag;
     ...
     * @since 1.1.1
     */
    public AbstractPlantUMLClassesDiagramElement(final String fullName) {
        name = fullName;
        elementTag = null;
    }
    ...
    public String getPlantUMLTextDescription() {
        return getElementTag().getTagName() + getAdditionalPlantUMLTextDescription();
    }
    ...
    /**
     * Sets the value of <code>elementTag</code>.
     *
     * @param value
     *            the <code>elementTag</code> to set, can be <code>null</code>.
     * @see #getElementTag()
     * @since 1.1.1
     */
    protected void setElementTag(final PlantUMLClassesDiagramElementTag value) {
        elementTag = value;
    }
