...
package net.sourceforge.plantumldependency.plantumldiagram.classes.element.stereotype;

import java.io.Serializable;

import net.sourceforge.mazix.components.clone.DeepCloneable;
import net.sourceforge.mazix.components.color.HTMLColor;
import net.sourceforge.plantumldependency.plantumldiagram.WithDescription;
