...
package net.sourceforge.plantumldependency.constants.log;
...
public final class ErrorConstants {
    ...
    public static final String DEPENDENCY_NAME_NULL_ERROR = "[error-plantuml-dependency-002] : The dependency name is null";

    /** The dependency null error message. */
    public static final String DEPENDENCY_NULL_ERROR = "[error-plantuml-dependency-003] : The dependency is null";

    /** The dependency type null error message. */
    public static final String DEPENDENCY_TYPE_NULL_ERROR = "[error-plantuml-dependency-004] : The dependency type is null";

    /** The display option null error message. */
    public static final String DISPLAY_OPTION_NULL_ERROR = "[error-plantuml-dependency-005] : The display option is null";
    ...
    public static final String JAVA_ANNOTATION_TYPE_NAME_NULL_ERROR = "[error-plantuml-dependency-009] : The java annotation type name is null";

    /** The java annotation type null error message. */
    public static final String JAVA_ANNOTATION_TYPE_PACKAGE_NAME_NULL_ERROR = "[error-plantuml-dependency-010] :  The java annotation type package name is null";

    /** The java parent type name null error message. */
    public static final String JAVA_PARENT_TYPE_NAME_NULL_ERROR = "[error-plantuml-dependency-011] : The java parent type name is null";
    ...
    public static final String JAVA_PARENT_TYPE_PACKAGE_NAME_NULL_ERROR = "[error-plantuml-dependency-013] : The java parent type package name is null";

    /** The parent type string not empty error message. */
    public static final String JAVA_PARENT_TYPE_STRING_NOT_EMPTY_NULL_ERROR = "[error-plantuml-dependency-014] : The java parent type string \"{0}\" should be null for this java type \"{1}\"";
    ...
    public static final String JAVA_TYPE_ANNOTATIONS_NULL_ERROR = "[error-plantuml-dependency-016] : The java type annotations dependencies is null";
