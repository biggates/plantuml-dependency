...
package net.sourceforge.plantumldependency.main.option.display;
...
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE5;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE6;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE7;
...
public class PlantUMLDependencyDisplayOptionTest extends DeepCloneableObjectTest < PlantUMLDependencyDisplayOption > {
    ...
    /**
     * Test method for
     * {@link net.sourceforge.plantumldependency.main.option.display.PlantUMLDependencyDisplayOption#getDefaultArgumentAsStringIfOptionSpecified(net.sourceforge.mazix.cli.command.CommandLine)}
     * .
     *
     * @throws CommandLineException
     */
