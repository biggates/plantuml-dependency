...
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST1;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST10;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST11;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST12;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST13;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST14;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST15;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST16;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST17;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST18;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST19;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST20;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST21;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST22;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST23;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST3;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST4;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST5;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST6;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST7;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST8;
import static net.sourceforge.plantumldependency.generic.type.impl.ImportDependenciesCollectionImplTest.IMPORT_COLLECTION_TEST9;
...
public final class PlantUMLDependencyTestConstants {
    ...
    public static final ClassDependencyTypeImpl CLASS_DEPENDENCY_TYPE27 = new ClassDependencyTypeImpl(
            "TestDisplayOption", "net.sourceforge.plantumldependency", IMPORT_COLLECTION_TEST16,
            new GenericDependencyImpl("BigInteger", "java.math"), new TreeSet < GenericDependency >(
                    ...
                    asList(new GenericDependency[] {new GenericDependencyImpl(new AnnotationDependencyTypeImpl(
                            "Override", "net.sourceforge.plantumldependency"))})));
    ...
    public static final ClassDependencyTypeImpl CLASS_DEPENDENCY_TYPE28 = new ClassDependencyTypeImpl(
            "TestDisplayOption", "net.sourceforge.plantumldependency", IMPORT_COLLECTION_TEST1, null,
    ...
    public static final ClassDependencyTypeImpl CLASS_DEPENDENCY_TYPE29 = new ClassDependencyTypeImpl(
            "TestDisplayOption", "net.sourceforge.plantumldependency", IMPORT_COLLECTION_TEST17,
            new GenericDependencyImpl("BigInteger", "java.math"), new TreeSet < GenericDependency >(
                    asList(new GenericDependency[] {new GenericDependencyImpl("DeepCloneable",
                            "net.sourceforge.mazix.components.clone")})), new TreeSet < GenericDependency >(
                    asList(new GenericDependency[] {new GenericDependencyImpl(new AnnotationDependencyTypeImpl(
    ...
    public static final InterfaceDependencyTypeImpl INTERFACE_DEPENDENCY_TYPE1 = new InterfaceDependencyTypeImpl(
            ...
            "net.sourceforge.plantumldependency.main.option.programminglanguage", IMPORT_COLLECTION_TEST18,
            new TreeSet < GenericDependency >(asList(new GenericDependency[] {
    ...
    public static final InterfaceDependencyTypeImpl INTERFACE_DEPENDENCY_TYPE2 = new InterfaceDependencyTypeImpl(
            ...
            "net.sourceforge.plantumldependency.main.option.programminglanguage", IMPORT_COLLECTION_TEST1,
            new TreeSet < GenericDependency >(), new TreeSet < GenericDependency >());
    ...
    public static final InterfaceDependencyTypeImpl INTERFACE_DEPENDENCY_TYPE4 = new InterfaceDependencyTypeImpl(
            ...
            "net.sourceforge.plantumldependency.main.option.programminglanguage", IMPORT_COLLECTION_TEST19,
            new TreeSet < GenericDependency >(asList(new GenericDependency[] {new GenericDependencyImpl(
    ...
    public static final InterfaceDependencyTypeImpl INTERFACE_DEPENDENCY_TYPE5 = new InterfaceDependencyTypeImpl(
            ...
            "net.sourceforge.plantumldependency.main.option.programminglanguage", IMPORT_COLLECTION_TEST20,
            new TreeSet < GenericDependency >(asList(new GenericDependency[] {new GenericDependencyImpl(
                    "DeepCloneable", "net.sourceforge.mazix.components.clone")})), new TreeSet < GenericDependency >());
    ...
    public static final InterfaceDependencyTypeImpl INTERFACE_DEPENDENCY_TYPE6 = new InterfaceDependencyTypeImpl(
            ...
            "net.sourceforge.plantumldependency.main.option.programminglanguage", IMPORT_COLLECTION_TEST21,
            new TreeSet < GenericDependency >(asList(new GenericDependency[] {new GenericDependencyImpl(
    ...
    public static final InterfaceDependencyTypeImpl INTERFACE_DEPENDENCY_TYPE12 = new InterfaceDependencyTypeImpl(
            "TestReadDependencyFromFileInterfaceWithExtendsGenericsInImport",
            "net.sourceforge.plantumldependency.main.option.programminglanguage", IMPORT_COLLECTION_TEST22,
            new TreeSet < GenericDependency >(asList(new GenericDependency[] {new GenericDependencyImpl(
                    "DeepCloneable", "net.sourceforge.mazix.components.clone")})), new TreeSet < GenericDependency >());
    ...
    public static final EnumDependencyTypeImpl ENUM_DEPENDENCY_TYPE1 = new EnumDependencyTypeImpl(
            "TestReadDependencyFromFileEnum", "net.sourceforge.plantumldependency.main.option.programminglanguage",
            IMPORT_COLLECTION_TEST1, new TreeSet < GenericDependency >(), new TreeSet < GenericDependency >());
