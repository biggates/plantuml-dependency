...
package net.sourceforge.plantumldependency.main.option.include;

import static net.sourceforge.mazix.components.constants.CharacterConstants.SPACE_CHAR;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE1;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE13;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE14;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE20;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE3;
import static net.sourceforge.plantumldependency.constants.PlantUMLDependencyTestConstants.COMMAND_LINE9;
...
import static net.sourceforge.plantumldependency.main.option.programminglanguage.PlantUMLDependencyProgrammingLanguageOptionTest.PROGRAMMING_LANGUAGE_OPTION1;
import static net.sourceforge.plantumldependency.main.option.programminglanguage.PlantUMLDependencyProgrammingLanguageOptionTest.PROGRAMMING_LANGUAGE_OPTION2;
...
public class PlantUMLDependencyIncludeOptionTest extends DeepCloneableObjectTest < PlantUMLDependencyIncludeOption > {
    ...
    /**
     * Test method for
     * {@link net.sourceforge.plantumldependency.main.option.include.PlantUMLDependencyIncludeOption#getDefaultArgumentAsStringIfOptionSpecified(net.sourceforge.mazix.cli.command.CommandLine)}
     * .
     *
     * @throws CommandLineException
     */
