...
public class ClassAbstractDependencyTypeImplTest extends DeepCloneableObjectTest < ClassAbstractDependencyTypeImpl > {
    ...
    /**
     * Test method for
     * {@link net.sourceforge.plantuml.dependency.generic.type.impl.classimpl.ClassDependencyTypeImpl#getAnnotations()}
     * .
     */
    @Test
    public void testGetAnnotations() {
        final Set < GenericDependency > annotations = CLASS_ABSTRACT_DEPENDENCY_TYPE1.getAnnotations();
    ...
    public void testGetPlantUMLClassesDiagramRelationsWithInterfaceAndImportDependenciesAndAnnotations() {
        assertEquals(new TreeSet < PlantUMLClassesDiagramRelation >(asList(new PlantUMLClassesDiagramRelation[] {
                ...
                PLANTUML_USE_RELATION_TEST27})),
                CLASS_ABSTRACT_DEPENDENCY_TYPE12.getPlantUMLClassesDiagramRelations(DEFAULT_DISPLAY_OPTIONS));
    }
     ...
     */
    @Test
    public void testGetPlantUMLClassesDiagramRelationsWithoutParentNorInterfaceAndImportDependenciesAndAnnotations() {
        assertEquals(new TreeSet < PlantUMLClassesDiagramRelation >(asList(new PlantUMLClassesDiagramRelation[] {
                ...
                PLANTUML_USE_RELATION_TEST27})),
                CLASS_ABSTRACT_DEPENDENCY_TYPE11.getPlantUMLClassesDiagramRelations(DEFAULT_DISPLAY_OPTIONS));
    }
