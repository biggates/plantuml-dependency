...
public class PlantUMLClassesDiagramEnumElementImplTest extends
    ...
    @DataPoint
    public static final PlantUMLClassesDiagramEnumElementImpl PLANTUML_ENUM_ELEMENT_TEST5 = null;
    ...
    public void testGetPlantUMLTextDescriptionWithoutStereotype() {
        assertEquals(ENUM_TAG.getTagName() + "net.sourceforge.plantuml.dependency.generic.GenericDependency",
    ...
    public void testGetPlantUMLTextDescriptionWithStereotype() {
        assertEquals(ENUM_TAG.getTagName()
