...
package net.sourceforge.plantumldependency.common.comparable;
...
/**
 * Generic JUnit test classes for testing classes which implements {@link Comparable}, allowing to
...
public abstract class ComparableObjectTest < T > extends ObjectTestWithString < T > {
     ...
     * @since 1.3.0
     */
    protected ComparableObjectTest() {
        super();
    }
