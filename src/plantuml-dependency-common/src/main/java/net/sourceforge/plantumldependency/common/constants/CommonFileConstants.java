...
/**
 * The class which defines common file constants.
 *
...
public final class CommonFileConstants {
    ...
    /** The string representing the PROPERTIES extension (for internationalization). */
    public static final String PROPERTIES_EXTENSION = ".properties";

    /** The string representing the txt extension (text files). */
