...
public class PlantUMLDependencyIncludeOptionTest extends DeepCloneableObjectTest < PlantUMLDependencyIncludeOption > {
    ...
    public void testFindAndParseArgumentAsStringOrGetDefaultArgumentWithExistingOption() throws CommandLineException {
        final String argument = INCLUDE_OPTION1.findAndParseArgumentAsStringOrGetDefaultArgument(COMMAND_LINE13);
    ...
    public void testFindAndParseArgumentAsStringOrGetDefaultArgumentWithExistingOptionWithNotExistingMandatoryArgument()
            throws CommandLineException {
        INCLUDE_OPTION1.findAndParseArgumentAsStringOrGetDefaultArgument(COMMAND_LINE20);
    }
    ...
    public void testFindAndParseArgumentAsStringOrGetDefaultArgumentWithNotExistingNotMandatoryOption()
            throws CommandLineException {
        final String argument = INCLUDE_OPTION1.findAndParseArgumentAsStringOrGetDefaultArgument(COMMAND_LINE3);
        assertNotNull(argument);
    }
    ...
    public void testFindAndParseArgumentAsStringOrGetDefaultArgumentWithTwoExistingOption() throws CommandLineException {
        INCLUDE_OPTION1.findAndParseArgumentAsStringOrGetDefaultArgument(COMMAND_LINE9);
    }
