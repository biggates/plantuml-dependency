/*
 PlantUMLDependencyDisplayNameOptionArgumentTest.java
...
/**
 * JUnit test classes for {@link PlantUMLDependencyDisplayNameOptionArgument}.
 *
 * @author Benjamin Croizet (<a href="mailto:graffity2199@yahoo.fr>graffity2199@yahoo.fr</a>)
 * @since 1.4.0
 * @version 1.4.0
 */
public class PlantUMLDependencyDisplayNameOptionArgumentTest extends
        ComparableAndDeepCloneableObjectTest < PlantUMLDependencyDisplayNameOptionArgument > {
    ...
    public void testGetFullUsageDescription() {
        assertEquals(
                ...
                DISPLAY_NAME_OPTION_ARGUMENT1.getFullUsageDescription().toString());
    }
    ...
    public void testGetMainUsage() {
        assertEquals("DISPLAY_NAME_PATTERN", DISPLAY_NAME_OPTION_ARGUMENT1.getMainUsage().toString());
    }

    /**
     * Test method for
     * {@link net.sourceforge.plantumldependency.cli.main.option.display.name.argument.PlantUMLDependencyDisplayTypeOptionArgument#parseArgument(java.lang.String)}
     * .
     *
    ...
    public void testParseArgumentNull() throws CommandLineException {
        DISPLAY_NAME_OPTION_ARGUMENT1.parseArgument(null);
    }
    ...
    public void testParseArgumentWithGoodPattern() throws CommandLineException {
        final Pattern argument = DISPLAY_NAME_OPTION_ARGUMENT1.parseArgument(".*");
        assertEquals(".*", argument.pattern());
    }

    /**
     * Test method for
     * {@link net.sourceforge.plantumldependency.cli.main.option.display.name.argument.PlantUMLDependencyDisplayNameOptionArgument#parseArgument(java.lang.String)}
     * .
     *
     * @throws CommandLineException
     */
    ...
    public void testParseArgumentWithEmptyString() throws CommandLineException {
        DISPLAY_NAME_OPTION_ARGUMENT1.parseArgument(BLANK_STRING);
    }
}
