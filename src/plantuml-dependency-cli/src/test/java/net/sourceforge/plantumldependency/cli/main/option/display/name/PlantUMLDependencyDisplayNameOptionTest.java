/*
 PlantUMLDependencyDisplayNameOptionTest.java
...
import static net.sourceforge.plantumldependency.cli.constants.PlantUMLDependencyTestConstants.COMMAND_LINE21;
import static net.sourceforge.plantumldependency.cli.constants.PlantUMLDependencyTestConstants.COMMAND_LINE22;
import static net.sourceforge.plantumldependency.cli.constants.PlantUMLDependencyTestConstants.COMMAND_LINE23;
...
/**
 * JUnit test classes for {@link PlantUMLDependencyDisplayNameOption}.
 *
 * @author Benjamin Croizet (<a href="mailto:graffity2199@yahoo.fr>graffity2199@yahoo.fr</a>)
 * @since 1.4.0
 * @version 1.4.0
 */
public class PlantUMLDependencyDisplayNameOptionTest extends
        ComparableAndDeepCloneableObjectTest < PlantUMLDependencyDisplayNameOption > {

    /** Display name option test 1 instance. */
    @DataPoint
    public static final PlantUMLDependencyDisplayNameOption DISPLAY_NAME_OPTION1 = new PlantUMLDependencyDisplayNameOption();

    /** Display name option test 2 instance. */
    @DataPoint
    public static final PlantUMLDependencyDisplayNameOption DISPLAY_NAME_OPTION2 = new PlantUMLDependencyDisplayNameOption();

    /** Display name option test 3 instance. */
    @DataPoint
    public static final PlantUMLDependencyDisplayNameOption DISPLAY_NAME_OPTION3 = null;
    ...
    public void testFindAndParseArgumentAsStringOrGetDefaultArgumentWithExistingOption() throws CommandLineException {
        final String argument = DISPLAY_NAME_OPTION1.findAndParseArgumentAsStringOrGetDefaultArgument(COMMAND_LINE21);
    ...
    public void testFindAndParseArgumentAsStringOrGetDefaultArgumentWithExistingOptionWithNotExistingMandatoryArgument()
            throws CommandLineException {
        DISPLAY_NAME_OPTION1.findAndParseArgumentAsStringOrGetDefaultArgument(COMMAND_LINE22);
    }
    ...
    public void testFindAndParseArgumentAsStringOrGetDefaultArgumentWithNotExistingNotMandatoryOption()
            throws CommandLineException {
        final String argument = DISPLAY_NAME_OPTION1.findAndParseArgumentAsStringOrGetDefaultArgument(COMMAND_LINE3);
        assertEquals(DEFAULT_DISPLAY_NAME_OPTIONS_STRING, argument);
    }
    ...
    public void testFindAndParseArgumentAsStringOrGetDefaultArgumentWithTwoExistingOption() throws CommandLineException {
        DISPLAY_NAME_OPTION1.findAndParseArgumentAsStringOrGetDefaultArgument(COMMAND_LINE23);
    }
    ...
    public void testFindAndParseArgumentOrGetDefaultArgumentWithExistingOption() throws CommandLineException {
        final Pattern argument = DISPLAY_NAME_OPTION1.findAndParseArgumentOrGetDefaultArgument(COMMAND_LINE21);
    ...
    public void testFindAndParseArgumentOrGetDefaultArgumentWithExistingOptionWithNotExistingMandatoryArgument()
            throws CommandLineException {
        DISPLAY_NAME_OPTION1.findAndParseArgumentOrGetDefaultArgument(COMMAND_LINE23);
    }
    ...
    public void testFindAndParseArgumentOrGetDefaultArgumentWithNotExistingNotMandatoryOption()
            throws CommandLineException {
        final Pattern argument = DISPLAY_NAME_OPTION1.findAndParseArgumentOrGetDefaultArgument(COMMAND_LINE3);
        assertEquals(DEFAULT_DISPLAY_NAME_OPTIONS_STRING, argument.pattern());
    }
    ...
    public void testGetDefaultArgumentAsStringIfOptionNotSpecified() throws CommandLineException {
        final String defaultArgument = DISPLAY_NAME_OPTION1
                .getDefaultArgumentAsStringIfOptionNotSpecified(COMMAND_LINE1);
        assertEquals(DEFAULT_DISPLAY_NAME_OPTIONS_STRING, defaultArgument);
    }
    ...
    public void testGetDefaultArgumentAsStringIfOptionSpecified() throws CommandLineException {
        final String defaultArgument = DISPLAY_NAME_OPTION1.getDefaultArgumentAsStringIfOptionSpecified(COMMAND_LINE23);
        assertEquals(DEFAULT_DISPLAY_NAME_OPTIONS_STRING, defaultArgument);
    }
    ...
    public void testGetDefaultArgumentIfOptionNotSpecified() throws CommandLineException {
        final Pattern defaultArgument = DISPLAY_NAME_OPTION1.getDefaultArgumentIfOptionNotSpecified(COMMAND_LINE1);
        assertEquals(DEFAULT_DISPLAY_NAME_OPTIONS_STRING, defaultArgument.pattern());
    }
    ...
    public void testGetDefaultArgumentIfOptionSpecified() throws CommandLineException {
        final Pattern defaultArgument = DISPLAY_NAME_OPTION1.getDefaultArgumentIfOptionSpecified(COMMAND_LINE23);
        assertEquals(DEFAULT_DISPLAY_NAME_OPTIONS_STRING, defaultArgument.pattern());
    }
    ...
    public void testGetFullUsage() {
        assertEquals(
                ...
                DISPLAY_NAME_OPTION1.getFullUsage().toString());
    }
    ...
    public void testGetMainUsage() {
        assertEquals("-dn DISPLAY_NAME_PATTERN", DISPLAY_NAME_OPTION1.getMainUsage().toString());
    }
    ...
    public void testGetValueSeparator() {
        assertEquals(SPACE_CHAR, DISPLAY_NAME_OPTION1.getValueSeparator());
    }
}
