...
public final class FineConstants {
    ...
    public static final String DISPLAY_OPTION_NOT_MANAGED_TYPE_FINE = "[fine-plantuml-dependency-005] : Display option \"{0}\" isn't managed, UML relations don't have to be generated";
    ...
    public static final String IMPORT_IS_AN_EXTENSION_AN_IMPLEMENTATION_OR_AN_ANNOTATION_FINE = "[fine-plantuml-dependency-007] : Import \"{0}\" is either an implementation, an extension or an annotation, skipping UML use relation generation here";

    /** The dependency is not displayable fine message. */
    public static final String DEPENDENCY_IS_NOT_DISPLAYABLE_FINE = "[fine-plantuml-dependency-008] : Dependency \"{0}\" is not displayable, UML relation doesn't have to be generated";
