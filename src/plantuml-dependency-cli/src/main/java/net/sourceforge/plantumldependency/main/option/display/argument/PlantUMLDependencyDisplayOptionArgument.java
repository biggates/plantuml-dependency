...
import static net.sourceforge.plantumldependency.constants.log.ErrorConstants.NOT_DISPLAY_ARGUMENT_ERROR;
import static net.sourceforge.plantumldependency.constants.log.ErrorConstants.SEVERAL_DISPLAY_ARGUMENTS_ERROR;
...
import static net.sourceforge.plantumldependency.main.option.display.argument.Display.valueOf;
import static net.sourceforge.plantumldependency.main.option.display.argument.Display.values;
