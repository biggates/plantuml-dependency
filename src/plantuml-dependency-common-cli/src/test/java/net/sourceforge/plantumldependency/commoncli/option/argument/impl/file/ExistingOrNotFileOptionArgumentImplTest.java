/*
 ExistingOrNotFileOptionArgumentImplTest.java
...
/**
 * JUnit test classes for {@link ExistingOrNotFileOptionArgumentImpl}.
 *
 * @author Benjamin Croizet (<a href="mailto:graffity2199@yahoo.fr>graffity2199@yahoo.fr</a>)
 * @since 1.3.0
 * @version 1.3.0
 */
public class ExistingOrNotFileOptionArgumentImplTest extends
        ComparableAndDeepCloneableObjectTest < ExistingOrNotFileOptionArgumentImpl > {

    /** Existing file option argument test 1 instance. */
    @DataPoint
    public static final OptionArgument < File > FILE_OPTION_ARGUMENT1 = new ExistingOrNotFileOptionArgumentImpl(true);

    /** Existing file option argument test 2 instance. */
    @DataPoint
    public static final OptionArgument < File > FILE_OPTION_ARGUMENT2 = new ExistingOrNotFileOptionArgumentImpl(false);

    /** Existing file option argument test 3 instance. */
    @DataPoint
    public static final OptionArgument < File > FILE_OPTION_ARGUMENT3 = new ExistingOrNotFileOptionArgumentImpl(true);

    /** Existing file option argument test 4 instance. */
    @DataPoint
    ...
    /** Test 2 file instance. */
    private static final File TEST_FILE2 = new File(DOT_CHAR + SLASH_CHAR + "hello");
    ...
    public void testParseArgumentWithExistingFile() throws CommandLineException, IOException {
        final File argument = FILE_OPTION_ARGUMENT1.parseArgument(TEST_FILE.getName());
        assertEquals(TEST_FILE.getCanonicalPath(), argument.getCanonicalPath());
    }
    ...
    public void testParseArgumentWithNonExistingPath() throws CommandLineException, IOException {
        final File argument = FILE_OPTION_ARGUMENT1.parseArgument("hello");
