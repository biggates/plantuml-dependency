/*
 ExistingFileOptionArgumentImplTest.java
...
/**
 * JUnit test classes for {@link ExistingFileOptionArgumentImpl}.
 *
 * @author Benjamin Croizet (<a href="mailto:graffity2199@yahoo.fr>graffity2199@yahoo.fr</a>)
 * @since 1.3.0
 * @version 1.3.0
 */
public class ExistingFileOptionArgumentImplTest extends
        ComparableAndDeepCloneableObjectTest < ExistingFileOptionArgumentImpl > {

    /** Existing file option argument test 1 instance. */
    @DataPoint
    public static final OptionArgument < File > FILE_OPTION_ARGUMENT1 = new ExistingFileOptionArgumentImpl(true);

    /** Existing file option argument test 2 instance. */
    @DataPoint
    public static final OptionArgument < File > FILE_OPTION_ARGUMENT2 = new ExistingFileOptionArgumentImpl(false);

    /** Existing file option argument test 3 instance. */
    @DataPoint
    public static final OptionArgument < File > FILE_OPTION_ARGUMENT3 = new ExistingFileOptionArgumentImpl(true);
    ...
    public void testGetFullUsageDescription() {
        assertEquals("FILE specifies an existing valid file path, not a directory. It can be absolute or relative.",
    ...
    public void testParseArgumentWithNonExistingPath() throws CommandLineException {
        FILE_OPTION_ARGUMENT1.parseArgument("hello");
    }
