/*
 IncludeFilePatternOptionArgumentImplTest.java
 ...
 * @version 1.3.0
 */
public class IncludeFilePatternOptionArgumentImplTest extends
        ComparableAndDeepCloneableObjectTest < IncludeFilePatternOptionArgumentImpl > {

    /** Include file pattern option argument test 1 instance. */
    @DataPoint
    public static final OptionArgument < FileSet > FILESET_OPTION_ARGUMENT1 = new IncludeFilePatternOptionArgumentImpl(
            true);

    /** Include file pattern option argument test 2 instance. */
    @DataPoint
    public static final OptionArgument < FileSet > FILESET_OPTION_ARGUMENT2 = new IncludeFilePatternOptionArgumentImpl(
            false);

    /** Include file pattern option argument test 3 instance. */
    @DataPoint
    public static final OptionArgument < FileSet > FILESET_OPTION_ARGUMENT3 = new IncludeFilePatternOptionArgumentImpl(
            true);

    /** Include file pattern option argument test 4 instance. */
    @DataPoint
    public static final OptionArgument < FileSet > FILESET_OPTION_ARGUMENT4 = new IncludeFilePatternOptionArgumentImpl(
    ...
    /**
     * Test method for
     * {@link net.sourceforge.plantumldependency.commoncli.option.argument.impl.filepattern.IncludeFilePatternOptionArgumentImpl#parseArgument(java.lang.String)}
     * . .
     *
