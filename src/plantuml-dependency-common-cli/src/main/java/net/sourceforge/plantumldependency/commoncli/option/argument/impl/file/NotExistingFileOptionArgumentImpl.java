/*
 NotExistingFileOptionArgumentImpl.java
...
import static net.sourceforge.plantumldependency.commoncli.constants.log.ErrorConstants.EXISTING_FILE_ARGUMENT_ERROR;
 ...
 * specifying a non directory non existing {@link File} argument.
 *
 * @author Benjamin Croizet (<a href="mailto:graffity2199@yahoo.fr>graffity2199@yahoo.fr</a>)
 * @since 1.3.0
 * @version 1.3.0
 */
public class NotExistingFileOptionArgumentImpl extends AbstractOptionArgument < File > {

    /** Serial version UID. */
    private static final long serialVersionUID = 982630705812913705L;

    /** The class logger. */
    private static final transient Logger LOGGER = getLogger(NotExistingFileOptionArgumentImpl.class.getName());
    ...
    private static final String USAGE_DESCRIPTION = MAIN_USAGE
            + " specifies a valid file path, where the file doesn't already exist and is not a directory. It can be absolute or relative.";
     ...
     * @since 1.3.0
     */
    public NotExistingFileOptionArgumentImpl(final boolean optionArgumentIsMandatory) {
    ...
    public File parseArgument(final String argument) throws CommandLineException {
        ...
        if (isNotEmpty(argument)) {
            ...
            if (file.isDirectory()) {
                ...
                throw new CommandLineException(buildLogString(EXISTING_FILE_ARGUMENT_ERROR, argument));
            } else {
